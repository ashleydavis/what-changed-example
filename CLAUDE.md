...
- The pre-commit hook compiles and tests whatever the change affects. If it refuses a commit, the code is broken. Fix the code.
...
- Never commit with tests failing or skipped. A commit is a claim that the project compiles and its tests pass.
